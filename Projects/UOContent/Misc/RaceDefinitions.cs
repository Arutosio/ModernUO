namespace Server.Misc
{
    public static class RaceDefinitions
    {
        public static void Configure()
        {
            ...
            RegisterRace(new DarkElf(3, 3));
            RegisterRace(new Orc(4, 4));
            RegisterRace(new Vampire(5, 5));
            RegisterRace(new Dwarf(6, 6));
            RegisterRace(new Demon(7, 7));
        }
        ...
        private class DarkElf : Race
        {
            ...
            public DarkElf(int raceID, int raceIndex)
                : base(raceID, raceIndex, "Dark Elf", "Dark Elfs", 605, 606, 607, 608, Expansion.ML)
            {
        ...
        private class Orc : Race
        {
            public Orc(int raceID, int raceIndex)
                : base(raceID, raceIndex, "Orc", "Orcs", 400, 401, 402, 403, Expansion.None)
            {
            }
        ...
        private class Vampire : Race
        {
            public Vampire(int raceID, int raceIndex)
                : base(raceID, raceIndex, "Vampire", "Vampires", 400, 401, 402, 403, Expansion.None)
            {
            }
        ...
        {
            public Dwarf(int raceID, int raceIndex)
                : base(raceID, raceIndex, "Dwarf", "Dwarfs", 400, 401, 402, 403, Expansion.None)
            {
            }
        ...
        {
            public Demon(int raceID, int raceIndex)
                : base(raceID, raceIndex, "Demon", "Demons", 400, 401, 402, 403, Expansion.None)
            {
            }
