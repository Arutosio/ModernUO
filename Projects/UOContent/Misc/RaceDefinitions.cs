...
namespace Server.Misc
{
    public static class RaceDefinitions
    {
        ...
        public static void Configure()
        {
            ...
            RegisterRace(new Human(0, 0, "Human", "Humans"));
            RegisterRace(new Elf(1, 1, "Elf", "Elves"));
            RegisterRace(new Gargoyle(2, 2, "Gargoyle", "Gargoyles"));

            //Custom AgeOfSaouls
            RegisterRace(new DarkElf(3, 3, "Dark Elf", "Dark Elves"));
            RegisterRace(new Orc(4, 4, "Orc", "Orcs"));
            RegisterRace(new Vampire(5, 5, "Vampire", "Vampires"));
            RegisterRace(new Dwarf(6, 6, "Dwarf", "Dwarfs"));
            RegisterRace(new Demon(7, 7, "Demon", "Demons"));
        }
        ...
        {
            public Human(int raceID, int raceIndex, string name, string pluralName)
        ...
        private class Elf : Race
        {
            ...
            public Elf(int raceID, int raceIndex, string name, string pluralName)
                : base(raceID, raceIndex, name, pluralName, 605, 606, 607, 608, Expansion.ML)
            {
            }
        ...
        private class Gargoyle : Race
        {
            ...
            public Gargoyle(int raceID, int raceIndex, string name, string pluralName)
                : base(raceID, raceIndex, name, pluralName, 666, 667, 402, 403, Expansion.SA)
            {
            }
        ...
        private class DarkElf : Race
        {
            ...
            public DarkElf(int raceID, int raceIndex, string name, string pluralName)
                : base(raceID, raceIndex, name, pluralName, 605, 606, 607, 608, Expansion.ML)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
        ...
        {
            public Orc(int raceID, int raceIndex, string name, string pluralName)
                : base(raceID, raceIndex, name, pluralName, 400, 401, 402, 403, Expansion.None)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
        ...
        {
            public Vampire(int raceID, int raceIndex, string name, string pluralName)
                : base(raceID, raceIndex, name, pluralName, 400, 401, 402, 403, Expansion.None)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
        ...
        {
            public Dwarf(int raceID, int raceIndex, string name, string pluralName)
                : base(raceID, raceIndex, name, pluralName, 400, 401, 402, 403, Expansion.None)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
        ...
        {
            public Demon(int raceID, int raceIndex, string name, string pluralName)
                : base(raceID, raceIndex, name, pluralName, 400, 401, 402, 403, Expansion.None)
            {
            }
            public override bool ValidateHair(bool female, int itemID)
